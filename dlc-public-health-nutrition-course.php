...
<div class="row">
   ...
   <li><a href = "<?php echo $HomeURL;?>" title="Home">Home</a></li>
     <li class = "">Distance Learning Cell</li>
                    <li class = "active"> Public Health Nutrition Course</li>
                </ol>
...
<div class="left-menu">
    ...
    <?php
    $date=date('Y-m-d');
    if($mydb->checkTableRow("dlc_phnc_publish")>0){
   ...
   $newsrows=$mydb->gettable_Rows_whereCluse("dlc_phnc_publish",$whereClause); 
...
<div class="col-md-9 content-area">
                <h2 class="heading">Public Health Nutrition Course</h2>
...
<caption> NOTICE : </caption>
  ...
  <?php
    ...
    //$whereClause="approve_status='3' && language_id='1'   order by start_date desc" ;
   $newsrows2=$mydb->gettable_Rows_whereCluse("dlc_phnc_publish",$whereClause2); 
...
<?php
    ...
    //$whereClause="approve_status='3' && language_id='1'   order by start_date desc" ;
   $newsrows3=$mydb->gettable_Rows_whereCluse("dlc_phnc_publish",$whereClause3); 
...
<?php
    ...
    //$whereClause="approve_status='3' && language_id='1'   order by start_date desc" ;
   $newsrows4=$mydb->gettable_Rows_whereCluse("dlc_phnc_publish",$whereClause4); 
...
<?php
    ...
    //$whereClause="approve_status='3' && language_id='1'   order by start_date desc" ;
   $newsrows5=$mydb->gettable_Rows_whereCluse("dlc_phnc_publish",$whereClause5); 
