...
<div class="left-menu">
    ...
    <?php
    $date=date('Y-m-d');
    if($mydb->checkTableRow("dlc_hfwmc_publish")>0){
   ...
   $newsrows=$mydb->gettable_Rows_whereCluse("dlc_hfwmc_publish",$whereClause); 
...
<div class="col-md-9 content-area">
                <h2 class="heading">Health & Family Welfare management Course</h2>
...
<caption> NOTICE : </caption>
  ...
  <?php
    ...
    //$whereClause="approve_status='3' && language_id='1'   order by start_date desc" ;
   $newsrows2=$mydb->gettable_Rows_whereCluse("dlc_hfwmc_publish",$whereClause2); 
...
<?php
    ...
    //$whereClause="approve_status='3' && language_id='1'   order by start_date desc" ;
   $newsrows3=$mydb->gettable_Rows_whereCluse("dlc_hfwmc_publish",$whereClause3); 
   if(is_array($newsrows3)){
                      $no_of_rows2= count($newsrows3);
                     }else{
                      $no_of_rows2= $newsrows3;
                    }
 }
 ?>
...
<?php
    ...
    //$whereClause="approve_status='3' && language_id='1'   order by start_date desc" ;
   $newsrows4=$mydb->gettable_Rows_whereCluse("dlc_hfwmc_publish",$whereClause4); 
...
<?php
    ...
    //$whereClause="approve_status='3' && language_id='1'   order by start_date desc" ;
   $newsrows5=$mydb->gettable_Rows_whereCluse("dlc_hfwmc_publish",$whereClause5); 
