...
<div class="row">
		...
		<li class = "active"><?php echo "संपर्क  / प्रतिक्रिया फॉर्म"; ?></li>
...
<div class="col-md-9 content-area">
                <h2 class="heading">प्रतिक्रिया फॉर्म</h2>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="txtename">नाम</label>  
  <div class="col-md-4 inputGroupContainer">
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input  name="txtename" placeholder="नाम" class="form-control"  type="text" id="txtename" required>
    </div>
  </div>
</div>
...
<!-- Text input-->
       <div class="form-group">
  <label class="col-md-4 control-label" for="txtemail">ई मेल</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
  <input name="txtemail" placeholder="ई मेल पता" class="form-control"  type="text" id="txtemail" required>
    </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="txtphone">फ़ोन</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
  <input name="txtphone" placeholder="(845)555-1212" class="form-control" type="text" id="txtphone" required>
    </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="description">विवरण</label>
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
        	<textarea class="form-control" name="txtcomment" placeholder="विवरण" id="txtcomment" required></textarea>
  </div>
  </div>
</div>

<div class="form-group">
  <label class="col-md-4 control-label" for="code">कैप्चा <span class="star">*</span></label>
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
       <span> 
	   <img src="/hi/includes/captcha.php" alt="PHP Captcha">
  ...
  <div class="n_text">उपरोक्त चित्र में प्रदर्शित होने वाले अक्षर ऊपर दर्ज करें </div>
                        <div class="clear">  </div>
<div class="form-group">
                    <span class="input-group">
					<!--<input name="confirm password" type="text" class="input_class" id="confirm password" />-->
					<input name="code" type="text" id="code" placeholder='कैप्चा कोड' class="form-control" maxlength="6"/>
...
<!-- Button -->
  ...
  <div class="col-md-4" style="font-size:12px;">
    <!-- <button type="submit" class="btn btn-warning" id="submit">Send <span class="glyphicon glyphicon-send"></span></button> -->
		<input name="cmdsubmit" type="submit" class="btn btn-warning" id="cmdsubmit" title="जमा करें" value="Submit" />
  </div>
</div>
