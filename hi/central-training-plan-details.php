...
<div class="row">
   ...
   <li class = "active">Central Training Plan Details</li>
...
$whereClause=" m_id='$details_id' && m_type='2'  && approve_status='3' && language_id='1' order by page_postion asc" ;
			$leftrows11=$mydb->gettable_Rows_whereCluse("tbl_training_publish",$whereClause);

 
			  $leftrows11[0]['m_name'];
  $body=stripslashes(html_entity_decode($leftrows11[0]['m_content']));
                 ?>
<h2 class="heading"><?php echo $leftrows11[0]['m_name']; ?>  </h2>
