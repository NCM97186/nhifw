...
if($mydb->checkTable_threeRow("student_publish","m_url",$url,"approve_status",3,"language_id",2)>0){
			$contentrows=$mydb->gettable_RowsthreeColumn_where("student_publish","m_url",$url,"approve_status",3,"language_id",2);  
