...
include('../counter.php');
	...
	//echo 'mflag'.$mflagid;
	$whereClauseSub 	= "m_flag_id=".$mflagid." && menu_positions=$mp && approve_status=3 && language_id=2 order by page_postion asc " ;
	//$whereClauseSub 	= "menu_positions=$mp && approve_status=3 && language_id=2 order by page_postion asc " ;
					...
					<?php foreach($submenu as $sub){  ?>
						<tr>
							<td>
								...
								<?php } else { ?>
									<a href="<?php echo $HomeURL;?>/hi/cms/<?php echo $sub['m_url']; ?>"><?php echo $sub['m_name']; ?></a>
								<?php } ?>
							</td>
						</tr>
					<?php } ?>
