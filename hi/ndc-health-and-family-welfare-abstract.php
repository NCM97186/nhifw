...
<div class="left-menu">
             ...
             <ul class="menu-class treeview">
                  <?php 
                      ...
                      foreach($bottomrows as $key=>$value){  
                         ...
                         if ($value['m_url'] == 'health-and-family-welfare-abstract.php') {
                             $url_show = 'ndc-health-and-family-welfare-abstract.php';
                            $active1 = 'selected';
                        }
                        else
                        {
    ...
    <?php
    $date=date('Y-m-d');
    if($mydb->checkTableRow("ndc_health_family_walfare_publish")>0){
   ...
   $newsrows=$mydb->gettable_Rows_whereCluse("ndc_health_family_walfare_publish",$whereClause); 
...
<div class="col-md-9 content-area">
                <h2 class="heading"> Health And Family Welfare Abstract </h2>
                
 <table width="100%"  class="table table-bordered">
<caption> Health And Family Welfare Abstract </caption>
        <tbody>
            <tr>
                <th>
                    Sr.</th>
