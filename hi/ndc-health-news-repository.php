...
<div class="left-menu">
             ...
             <ul class="menu-class treeview">
                  <?php 
                      ...
                      foreach($bottomrows as $key=>$value){  
                        ...
                        if ($value['m_url'] == 'health-news-repository.php') {
                             $url_show = 'ndc-health-news-repository.php';
                            $active1 = 'selected';
                        }
                        else
                        {
    ...
    <?php
    $date=date('Y-m-d');
    if($mydb->checkTableRow("ndc_health_repository_publish")>0){
   ...
   $newsrows=$mydb->gettable_Rows_whereCluse("ndc_health_repository_publish",$whereClause); 
...
<div class="col-md-9 content-area">
                <h2 class="heading">Health News Repository </h2>
                
 <table width="100%"  class="table table-bordered">
<caption> Health News Repository </caption>
        <tbody>
            <tr>
                <th>
                    Sr.</th>
