...
<div class="left-menu">
             ...
             <ul class="menu-class treeview">
                  <?php 
                      ...
                      foreach($bottomrows as $key=>$value){  
                         ...
                         if($value['m_url'] == 'current-awareness-service-of-journals.php') {
                             $url_show = 'ndc-current-awareness-service-of-journals.php';
                            $active1 = 'selected';
                        }
                        else
                        {
                        ...
                        ?>
                          ...
                          <li  >
                            <a  href="<?php echo $url_show;?>" title="<?php echo $value['m_name'];?>" class="<?php echo $active1; ?>" ><?php echo $value['m_name'];?> </a>
    ...
    <?php
    $date=date('Y-m-d');
    if($mydb->checkTableRow("ndc_current_awareness_service_publish")>0){
   ...
   $newsrows=$mydb->gettable_Rows_whereCluse("ndc_current_awareness_service_publish",$whereClause); 
...
<div class="col-md-9 content-area">
                <h2 class="heading"> Current Awareness Service of Journals </h2>
                
 <table width="100%"  class="table table-bordered">
<caption> Current Awareness Service of Journals </caption>
        <tbody>
            <tr>
                <th>
                    Sr.</th>
