...
if($startdate !="" && $expairydate !="")
{
		...
		if($errmsg=="")
		{
		 ...
		 if($textcatgory=='5'){
		 	 ...
		 	 $date=date('Y-m-d');
	      	 $sql="SELECT * FROM tender_publish where language_id='1' and approve_status='3' and date(end_date) < '$date' $querywhere";
		 }
		  else if($textcatgory=='1'){
		 	 
		 	 $date=date('Y-m-d');
	         $sql="SELECT * FROM whatsnew_publish where language_id='1' and approve_status='3' and date(end_date) < '$date' $querywhere";
		 }
		  else if($textcatgory=='2'){

		 	 $date=date('Y-m-d');
	         $sql="SELECT * FROM latest_information_publish where language_id='1' and approve_status='3' and date(end_date) < '$date' $querywhere";
		 }

		 else  if($textcatgory=='3'){
		 	 
		 	 $date=date('Y-m-d');
	         $sql="SELECT * FROM importent_information_publish where language_id='1' and cat_id='1' and approve_status='3' and date(end_date) < '$date' $querywhere";
		 }
		 else if($textcatgory=='4'){
		 	 
		 	 $date=date('Y-m-d');
	      	 $sql="SELECT * FROM importent_information_publish where language_id='1' and cat_id='2' and approve_status='3' and date(end_date) < '$date' $querywhere";

		 }
		  else if($textcatgory=='6'){
			 	 
			 	 $date=date('Y-m-d');
		      	 $sql="SELECT * FROM recruitment_publish where language_id='1' and approve_status='3' and date(end_date) < '$date' $querywhere";
		 }
		 else if($textcatgory=='7'){
			 $date=date('Y-m-d');
			 $sql="SELECT * FROM employee_corner_publish where language_id='1'  and approve_status='3' and date(end_date ) < '$date' $querywhere ";
		  }

		   else if($textcatgory=='8'){
			 $date=date('Y-m-d');
			 $sql="SELECT * FROM tbl_training_publish where language_id='1'  and approve_status='3' and date(end_date ) < '$date' $querywhere ";
		  }

		  else if($textcatgory=='9'){
			 
			 $date=date('Y-m-d');
			 $sql="SELECT * FROM publication_publish where language_id='1'  and approve_status='3' and date(end_date ) < '$date' $querywhere ";
		  }
		  else
		  {
		  ...
		  /*	$date=date('Y-m-d');
		  	    ...
		  	    $sql_2="SELECT * FROM whatsnew_publish where language_id='1' and approve_status='3' and date(end_date) < '$date' $querywhere";

		  	    $sql_3="SELECT * FROM latest_information_publish where language_id='1' and approve_status='3' and date(end_date) < '$date' $querywhere";
		  	    $sql_4="SELECT * FROM importent_information_publish where language_id='1' and cat_id='1' and approve_status='3' and date(end_date) < '$date' $querywhere";

		  	    $sql_4="SELECT * FROM importent_information_publish where language_id='1' and cat_id='2' and approve_status='3' and date(end_date) < '$date' $querywhere";

		  	    $sql_6="SELECT * FROM recruitment_publish where language_id='1' and approve_status='3' and date(end_date) < '$date' $querywhere";
			...
			$date=date('Y-m-d');
	 		$sql="SELECT * FROM whatsnew_publish where language_id='1' and approve_status='3' and date(end_date ) < '$date'";
		    }
	  		/* $sql=mysql_query($sql);
		   ...
		   <?php } else {					
				if($textcatgory=='2') {
				?>
		   <a href="<?php echo $HomeURL;?>/cms/meeting.php?page=<?php echo $page_url; ?>" title="<?php echo $m_name;?>"><?php echo $m_name;?></a>
		   <?php } 
				elseif($textcatgory=='3' || $textcatgory=='4') {
				?>
		   <a href="<?php echo $HomeURL;?>/cms/important_circulars.php?page=<?php echo $page_url; ?>" title="<?php echo $m_name;?>"><?php echo $m_name;?></a>
		   <?php }
				elseif($textcatgory=='5') {
				?>
		   <a href="<?php echo $HomeURL;?>/cms/tender.php?page=<?php echo $page_url; ?>" title="<?php echo $m_name;?>"><?php echo $m_name;?></a>
		   <?php }
				elseif($textcatgory=='6') {
				?>
		   <a href="<?php echo $HomeURL;?>/cms/vacancy.php?page=<?php echo $page_url; ?>" title="<?php echo $m_name;?>"><?php echo $m_name;?></a>
		   <?php }
				elseif($textcatgory=='7') {
				?>
		   <a href="<?php echo $HomeURL;?>/cms/employee_corner.php?page=<?php echo $page_url; ?>" title="<?php echo $m_name;?>"><?php echo $m_name;?></a>
		   <?php }
			else { ?>
			 <a href="<?php echo $HomeURL;?>/news/<?php echo $page_url; ?>" title="<?php echo $m_name;?>"><?php echo $m_name;?></a>
			<?php } ?>
