...
if($mydb->checkTable_threeRow("student_publish","m_url",$url,"approve_status",3,"language_id",1)>0){
			$contentrows=$mydb->gettable_RowsthreeColumn_where("student_publish","m_url",$url,"approve_status",3,"language_id",1);  
...
foreach($contentrows as $key=>$value){ 
			...
			$rootid12=get_student_parent($page_id);
			$s_name=get_student_main($page_id);
		$m_url=$value['m_url'];
...
<div class="left-menu">
<div class="left">
<?php include("../left_inner_student_menu.php");?>
