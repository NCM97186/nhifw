...
<a href="#skipContent"><img src="<?php echo $HomeURL;?>/images/ico-skip.png" width="24" height="24" alt="Skip Main Content" title="Skip Main Content"></a></li>
        ...
        <li><a href="<?php echo $HomeURL;?>/sitemap.php"><img src="<?php echo $HomeURL;?>/images/ico-site-search.png" width="24" height="24" title="Icons Site Search" alt="site-search"></a>
        
        <ul>
        <li class="slave">
        <label for="q">Search</label>
		<form  action="<?php echo $HomeURL;?>/search.php" id="cse-search-box" name="searchform" onsubmit=" if(this.q.value == '' || this.q.value.length < 1) { alert('Please enter a Search Keyword'); return false; }else {return gsearch('searchform')}">
			...
			<button type="submit"  class="search-buttion"> </button>
...
<input type="button" class="search-buttion" title="Search" value="submit"> -->
        ...
        <li><a href="<?php echo $HomeURL;?>/sitemap.php"><img src="<?php echo $HomeURL;?>/images/ico-sitemap.png" width="24" height="24" alt="sitemap" title="Sitemap"></a></li>
        <li class="contact-show"><a href="<?php echo $HomeURL;?>/hi" class="last-font" title="हिंदी">हिंदी <span class="hidethis">Hindi Link:This will open in new window.</span></a></li>
	</ul>
        </div>
        </div>
        </div>