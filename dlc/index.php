...
require_once "../includes/functionstudent.inc.php";
include('../../design.php');
...
if($mydb->checkTable_threeRow("distance_learning_publish","m_url",$url,"approve_status",3,"language_id",1)>0){
			$contentrows=$mydb->gettable_RowsthreeColumn_where("distance_learning_publish","m_url",$url,"approve_status",3,"language_id",1);  
...
<div class="row">
   ...
   <li class = "javascript:void(0);">Distance Learning Cell</li>
