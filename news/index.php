...
if($mydb->checkTable_threeRow("whatsnew_publish","page_url",$url,"approve_status",3,"language_id",1)>0){
			$contentrows=$mydb->gettable_RowsthreeColumn_where("whatsnew_publish","page_url",$url,"approve_status",3,"language_id",1);  
