...
<title>Manage Employee Corner add/update: LPAI</title>
<!-- admin css  -->
...
<div class="breadcrum">
  <span class="submenuclass"><a href="welcome.php" title="Dashboard">Dashboard</a></span>
			...
			<span class="submenuclass"><a href="manage_employee.php" title="Manage Employee Corner">Manage Employee Corner</a></span>
			 <span class="submenuclass">>> </span> 
			<span class="submenuclass">Add/Update Employee Corner</span>
	</div>
<div class="clear"> </div>
</div>  
...
<p><img alt="error" src="images/error.png"> <span>Attention! <br /></span><?php echo $errmsg; ?></p>
 ...
 <h3 class="manageuser">Add/Update Employee Corner</h3>
...
<div class="frm_row"> <span class="label1">
		...
		<div class="frm_row"> <span class="label1">
<label for="texcat">Tender Type :</label>
<span class="star">*</span></span> <span class="input1">
<select name="texttype" id="texttype" autocomplete="off" >
<option value="">Select</option>
<?php 
foreach($tender_type as $key=>$value)
{
	?>
...
<!--<div id="txtevent"<?php if($texcat=='3' || $rr['cat_id']=='3') {?> style="display:block" <?php } else {?>style="display:none" <?php } ?>>
<div class="frm_row"> <span class="label1">
   ...
   <div class="frm_row"> <span class="label1">
              ...
              <label for="addphoto">Add More Photo:</label>
              <span class="star">*</span></span> <span class="input1">
              <input type="radio" name="addphoto" id="addphoto" autocomplete="off"  value="1" <?php if($rr['c_new_status']=='1'){ echo 'checked';} else ?> />Yes &nbsp;<input type="radio" name="addphoto" autocomplete="off" value="0" <?php if($rr['more_photo']=='0'){ echo 'checked'; } ?>/>No 
               </span>
              <div class="clear"></div>
			  <div class="loading"></div>
            </div>
