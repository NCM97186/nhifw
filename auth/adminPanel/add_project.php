...
$tableFieldsName_old=array("m_flag_id","m_type","language_id","m_name","m_url","m_title","m_keyword","m_description","content","doc_uplode","linkstatus","create_date","approve_status","admin_id","current_version");
$tableFieldsValues_send=array("$projectcategory","$texttype","$txtlanguage","$txtename","$url","$page_url","$txtekeyword","$txtmeta_description","$txtcontentdesc","$txtuplode","$link","$createdate","$txtstatus","$user_id","0");
...
$version =1; }
	...
	$tableFieldsName_old=array("m_type","m_publish_id","m_flag_id","language_id","m_name","m_url","m_title","m_keyword","m_description","content","doc_uplode","linkstatus","create_date","approve_status","admin_id","current_version");
	$tableFieldsValues_send=array("$texttype","$page_id","$projectcategory","$txtlanguage","$txtename","$url","$page_url","$txtekeyword","$txtmeta_description","$txtcontentdesc","$txtuplode","$link","$createdate","$txtstatus","$user_id","$version");
