...
//$query ="select * from whatsnew where 1 $wherecluse ORDER BY page_postion ASC ";
...
<?php if($role_map['draft']=='DR' || $user_id=='101'){?><li class="new-icon">
    <a href="whatsnew.php" title="New"><span class="icon-28-new"></span>New</a></li>
              <?php }?>
...
<select class="inputbox" name="btneng">
 ...
 <input type="submit" name="btnsubmit" value="Search" class="button_m"/>
    ...
    <div id="response"> </div>
							...
							<a href="manage_whatsnew.php?inactiveid=<?php echo base64_encode($m_id); ?>&random=<?php echo $_SESSION['logtoken'];?>" onclick="return confirm('Are you sure you want to Inactive this page?')"title="Inactive">Inactive</a>&nbsp;/&nbsp;<?php }?>
