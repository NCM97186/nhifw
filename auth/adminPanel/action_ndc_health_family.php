...
$cat_id='1';
$tableName_send="ndc_health_family_walfare";
...
if($txtstatus=='3')
{
$tableName_send="ndc_health_family_walfare_publish";
...
header("location:manage_ndc_health_family_welfare.php");	
exit;	
}
}
if(isset($_POST['cmdsubmit']) && $_GET['editid']!='')
...
$sql=mysqli_query($conn,"Select * from ndc_health_family_walfare_publish $whereclause");
...
if($_GET['editid']!='')
{
        $rq = mysqli_query($conn,"select * from ndc_health_family_walfare where id='".$_GET['editid']."'");
