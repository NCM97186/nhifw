...
<div class="frm_row"> <span class="label1">
            ...
            <?php
$nav_query = mysqli_query($conn,"select * from distance_learning where approve_status='3' and m_flag_id='0' and language_id='$language'");
//echo "select * from distance_learning where approve_status='3' and m_flag_id='0' and language_id='$language' and module_id='".$_SESSION['user']."'";
//echo "select * from distance_learning where approve_status='3' and m_flag_id='0' and language_id='$language'";
...
function build_child($oldID)               // Recursive function to get all of the children...unlimited depth
{
	 ...
	 //echo "select * from distance_learning where approve_status='3' and m_flag_id='$oldID'";
...
echo '<select name="distance_learningcategory" id="distance_learningcategory">'.$tree.'</select>';
