...
$page_id1=content_desc(base64_encode($page_id));
...
$edit_employee ="select * from ndc_health_repository where id='$page_id1'";
...
<div class="heading-holder" style=" min-height:500px;">
        ...
        <span align="left" colspan="2" class="label1"><a href="../../upload/ndc/<?php echo $docs_file; ?>">Download</a></span>
        <?php }
        else if($ext_url !='') {?>
