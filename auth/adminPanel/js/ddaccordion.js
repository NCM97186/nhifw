...
ddaccordion.init({
	...
	togglehtml: ["suffix", "<img src='arrow.png' class='statusicon' />", "<img src='down-arrow.png' class='statusicon' />"], //Additional HTML added to the header when it's collapsed and expanded, respectively  ["position", "html1", "html2"] (see docs)
