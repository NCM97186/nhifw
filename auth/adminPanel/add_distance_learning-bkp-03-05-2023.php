...
if($txtlanguage=='2')
{
	...
	if(trim($txtename)=="")
		{
		$errmsg .= "Please Enter distance_learning Title "."<br>";
		}
		
		// if(trim($texttype)=="")
		// {
		// 	$errmsg .="Please Select distance_learning Type."."<br>";
...
else
{
		if(trim($txtename)=="")
		{
		$errmsg .= "distance_learning title should be alphanumeric "."<br>";
		}
		if(trim($txtename)!="")
		{			
...
$tableFieldsName_old=array("m_flag_id","m_type","language_id","m_name","m_url","m_title","m_keyword","m_description","content","doc_uplode","linkstatus","create_date","update_date","approve_status","admin_id","page_postion");
$tableFieldsValues_send=array("$distance_learningcategory","$texttype","$txtlanguage","$txtename","$url","$page_url","$txtekeyword","$txtmeta_description","$txtcontentdesc","$txtuplode","$link","$createdate","","$txtstatus","$user_id","");
...
$tableFieldsName_old=array("m_type","m_publish_id","m_flag_id","language_id","m_name","m_url","m_title","m_keyword","m_description","content","doc_uplode","linkstatus","create_date","update_date","approve_status","admin_id","page_postion");
$tableFieldsValues_send=array("$texttype","$page_id","$distance_learningcategory","$txtlanguage","$txtename","$url","$page_url","$txtekeyword","$txtmeta_description","$txtcontentdesc","$txtuplode","$link","$createdate","","$txtstatus","$user_id","");
...
<title>Add Distance Learning: <?php echo $sitename;?></title>
...
<script language="javascript" type="text/javascript">
	function adddistance_learningtype(id) {
	if(id=='1')
...
<div class="breadcrum">
  <span class="submenuclass"><a href="welcome.php">Dashboard</a></span>
			...
			<span class="submenuclass"><a href="manage_distance_learning.php"><?php echo "Manage Distance Learning";?></a></span>
			 <span class="submenuclass">>> </span> 
			<span class="submenuclass">Add Distance Learning</span>
...
<p><img alt="error" src="images/error.png"> <span>Attention! <br /></span><?php echo $errmsg; ?></p>
	...
	<div class="internalpage_heading">
 <h3 class="manageuser">Add Distance Learning</h3>
...
<select name="texttype" id="texttype" autocomplete="off"  onChange="adddistance_learningtype(this.value)" >
