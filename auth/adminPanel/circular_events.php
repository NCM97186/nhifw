...
$eventhi = check_input($_POST['eventhi']);
...
<title>Manage Circular,Events,Awards,National Policyadd/update: <?php echo $sitename;?></title>
<!-- admin css  -->
...
<div class="breadcrum">
  <span class="submenuclass"><a href="welcome.php" title="Dashboard">Dashboard</a></span>
			...
			<span class="submenuclass"><a href="manage_circular_events.php" title="Manage Circular,Events,Awards,National Policy& Tenders">Manage Events/Awards/Circular/National Policy</a></span>
			 <span class="submenuclass">>> </span> 
			<span class="submenuclass">Add/Update Circular,Events,Awards,&amp; National Policy</span>	</div>
<div class="clear"> </div>
</div>  
...
<p><img alt="error" src="images/error.png"> <span>Attention! <br /></span><?php echo $errmsg; ?></p>
 ...
 <h3 class="manageuser">Add/Update Circular,Events,Awards &amp; National Policy</h3>
...
<div class="clear"></div>
			...
			<div class="frm_row" id="category" <?php if($texcat=='2' || $rr['cat_id']=='2') {?> style="display:block;"<?php }else{ ?> style="display:none;"<?php }?>> 
				<span class="label1">
				<label for="txtcategory">Circular Category:</label><span class="star">*</span></span> <span class="input1">
				<?php $sqlCat = "Select * from whatsnew_category where c_type = 2";
					  $rsCat  = mysqli_query($conn,$sqlCat);
				?>
				<select name="txtcategory" id="txtcategory"  autocomplete="off" >
				<option value=""> Select </option>
				<?php while($category = mysqli_fetch_array($rsCat)) { ?>
					<option value="<?php echo $category['c_id'];?>" <?php if($rr['whatsNew_cat'] == $category['c_id'] || $category['c_id'] == $txtcategory ) { echo "selected = 'selected'";}?>><?php echo $category['c_name'];?></option>
				<?php }?>
				</select>
				<div class="clear"></div>
            </div>	
