...
$edit_information ="select * from latest_information_publish where m_id='$page_id'";
...
<title>Latest Information View: <?php echo $sitename;?></title>
...
<div class="heading-holder" style=" min-height:500px;">
        ...
        <span align="left" colspan="2" class="label1"><a href="../../upload/latest/<?php echo $doc_uplode; ?>">Download</a></span>
        <?php }
        else if($linkstatus !='') {?>
