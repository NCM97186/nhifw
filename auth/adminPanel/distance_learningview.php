...
$edit_contrator ="select * from distance_learning where m_id='$page_id1'";
...
<title>Distance Learning View Page:NIHFW</title>
...
<div class="heading-holder" style=" min-height:500px;">
        ...
        <span align="left" colspan="2" class="label1"><a href="../../upload/distance_learning/<?php echo $doc_uplode; ?>">Download</a></span>
        <?php }
        else if($linkstatus !='') {?>
