...
$txtuplode1= content_desc(check_input($_POST['uploadImage']));
...
if($txtlanguage=='2')
		...
		if ($_FILES["uploadImage"]["tmp_name"]!="")
	{
		...
		echo $nsection=substr($section,0,8);
...
if ($_FILES["txtuplode"]["name"]!="")
	...
	$old =array("m_flag_id","m_type","menu_positions","language_id","m_name","m_url","m_title","m_keyword","m_description","content","doc_uplode","linkstatus","update_date","approve_status","admin_id","upload_img");
	$new =array("$menucategory","$texttype","$txtpostion","$txtlanguage","$txtename","$url","$page_url","$txtekeyword","$txtmeta_description","$txtcontentdesc","$txtuplode","$link","$update_date","$txtstatus","$user_id","$txtuplode1");
...
$row=mysqli_num_rows($sql); 
 ...
 $sql="INSERT INTO menu_publish_versions(m_type,m_publish_id,m_flag_id,menu_positions,language_id,m_name,m_url,m_title,m_keyword,m_description,content,doc_uplode,linkstatus,approve_status,admin_id,page_postion,module_id,pdf_body,create_versions_date)
	 SELECT m_type,m_publish_id,m_flag_id,menu_positions,language_id,m_name,m_url,m_title,m_keyword,m_description,content,doc_uplode,linkstatus,approve_status,admin_id,page_postion,module_id,pdf_body,update_date
  ...
  mysqli_query($conn,$sql);
	...
	$old =array("m_type","m_flag_id","menu_positions","language_id","m_name","m_url","m_title","m_keyword","m_description","content","doc_uplode","linkstatus","update_date","approve_status","admin_id","upload_img");
	$new =array("$texttype","$menucategory","$txtpostion","$txtlanguage","$txtename","$url","$page_url","$txtekeyword","$txtmeta_description","$txtcontentdesc","$txtuplode","$link","$update_date","$txtstatus","$user_id","$txtuplode1");
$useAVclass->UpdateQuery($tableName_send,$whereclause,$old,$new);
...
$value=$useAVclass->insertQuery($tableName,$tableFieldsName_send,$tableFieldsValues_send);
	...
	{
		$page_id=$cid;
	$tableFieldsName_send=array("m_type","m_publish_id","m_flag_id","menu_positions","language_id","m_name","m_url","m_title","m_keyword","m_description","content","doc_uplode","linkstatus","update_date","approve_status","admin_id","upload_img");
	$tableFieldsValues_send=array("$texttype","$page_id","$menucategory","$txtpostion","$txtlanguage","$txtename","$url","$page_url","$txtekeyword","$txtmeta_description","$txtcontentdesc","$txtuplode","$link","$update_date","$txtstatus","$user_id","$txtuplode1");
...
<div class="frm_row"> <span class="label1">
            ...
            <?php
$nav_query = mysqli_query($conn,"select * from menu where approve_status='3' and m_flag_id='0' and language_id='$language_id'");
 ...
 <div class="frm_row"> <span class="label1">
              ...
              <!-- <span class="star">*</span> -->
			   ...
			   <input type="file" name="uploadImage" id="uploadImage" />
				<?php if($upload_img !='') {?>
		   <img src="../../upload/bottom_image/<?php echo $upload_img;?>" alt="" title="" align="center" width="80" height="90" />
		   <?php }?> 
				</span>
				<div class="clear"></div>
			  </div>
...
<div class="frm_row"> <span class="label1">
  ...
  <span class="star">*</span></span> <span class="input1">
  	<select name="txtpostion" id="txtpostion" autocomplete="off">
		...
		{
			?>
		<option value="<?php echo content_desc($key); ?>"<?php if ($menu_positions==$key) echo 'selected="selected"';?>><?php if($key=='1' || $key=='2' || $key=='3' || $key=='4') echo $value; ?></option>
		<?php }
		 ?>
	</select>
</span>
