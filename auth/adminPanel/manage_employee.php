...
<?php 
  ...
  $querywhere .=" and approve_status=$txtstatus"; 
	...
	if($btneng!='')
	  ...
	  if($errmsg=='')	
	  {
 $query ="select * from combine where cat_id =4 $querywhere ORDER BY page_postion ASC "; 
	  }
	 else
	{
...
$query ="select * from combine where cat_id =4 $wherecluse ORDER BY page_postion ASC ";
}
?>      
