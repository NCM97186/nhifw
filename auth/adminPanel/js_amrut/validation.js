...
function edit_email(formname)
{
    ...
    if(MM_validateForm(formname,'txtemail','Please enter valid email id',''))
    {
...
if(MM_validateForm(formname,
	'txtename','Please enter Title Name','R', 
...
function add_update(formname)
{
if(MM_validateForm(formname,
	'txtename','Please enter Subject / Title','R', 
	'txtlanguage','Please enter Language','R', 
	'txtuplode','Please upload file','R',
	'startdate','Please enter Publishing date','R',
	'txtstatus','Please select Page Status','R'
...
{
if(MM_validateForm(formname,
	'user_id','Please Select user Name','R',
...
if(MM_validateForm(formname,
	...
	function add_report(formname)
	{ 
	if(MM_validateForm(formname,
		'txtename','Please enter Subject / Title','R',
			'reporttype','Please select Type of Report','R',
			'txtlanguage','Please select Page Language','R',
			'txtuplode','Please Upload File','R',
			'startdate','Please Enter Date of Issue ','R',
			'txtstatus','Please Select Page Status.','R'))
		{
		return true;
		} 
...
function add_pbnotice(formname)
	{ 
	if(MM_validateForm(formname,
		'txtename','Please enter Subject / Title','R',
			'txtlanguage','Please select Page Language','R',
...
function edit_pbnotice(formname)
	{ 
	if(MM_validateForm(formname,
		'txtename','Please enter Subject / Title','R',
			'txtlanguage','Please select Page Language','R',
...
function manage_agreement(formname)
{
	//alert('mnvcmncvnmvc');
if(MM_validateForm(formname,
	'txtlanguage','Please enter Language','R', 
	'txtename','Please enter Subject / Title','R', 
	//'txtuplode','Please Upload File','R',
	'agreement_type','Please select atleast one type','R', 
	'txtstatus','Please select page status','R'
