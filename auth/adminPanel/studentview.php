...
$edit_student ="select * from student where m_id='$page_id1'";
...
<div class="heading-holder" style=" min-height:500px;">
        ...
        <span align="left" colspan="2" class="label1"><a href="../../upload/student/<?php echo $doc_uplode; ?>">Download</a></span>
        <?php }
        else if($linkstatus !='') {?>
