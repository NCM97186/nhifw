...
if(($login=="") && ($password==""))
	...
	elseif($_POST['code']!="")
	{
	 ...
	 $qry="SELECT id,login_name,user_name,user_pass,role_id,last_login_date,flag_id from admin_login where user_status='1'"; 
    ...
    JQUERY4U.UTIL =
    {
        setupFormValidation: function()
        {
            ...
            $("#loginform").validate({
                ...
                messages: {
                    txtusername: "Please enter character in User Id",
...
<div class="admin-heading"> <h1><img src="<?php echo $HomeURL;?>/images/nihfw-logo.jpg" class="img-responsive" title="NIHFW" alt="NIHFW" width='350' height='100' > <br /> <br /><i>Administration </i></h1></div>
      ...
      <div class="admin_row">
         ...
         <span class="input2"><input name="txtpassword" type="password" class="input_class2" id="txtpassword"  maxlength="20" autocomplete="off" placeholder ="Password"/></span>
        <div class="clear"> </div>
      </div>
