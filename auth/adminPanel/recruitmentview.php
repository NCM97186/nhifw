...
$edit_recruitment ="select * from recruitment_publish where m_id='$page_id1'";
$recruitment_result = mysqli_query($conn,$edit_recruitment);
$res_rows=mysqli_num_rows($recruitment_result);
$fetch_result=mysqli_fetch_array($recruitment_result);
...
<title>Recruitment View Details:<?php echo $sitename;?></title>
...
<div class="heading-holder" style=" min-height:500px;">
        ...
        <span align="left" colspan="2" class="label1"><a href="../../upload/recruitment/<?php echo $docs_file; ?>">Download</a></span>
        <?php }
        else if($ext_url !='') {?>
