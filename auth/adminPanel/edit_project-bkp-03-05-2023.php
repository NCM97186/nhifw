...
if ($_FILES["txtuplode"]["name"]!="")
	...
	$new =array("$projectcategory","$texttype","$txtpostion","$txtlanguage","$txtename","$url","$page_url","$txtekeyword","$txtmeta_description","$txtcontentdesc","$txtuplode","$link","$startdate","$expairydate","$update_date","$txtstatus","$user_id","$create_version","$media_page","$linktype");
...
$row=mysqli_num_rows($sql); 
 ...
 $sql="INSERT INTO project_publish_versions(m_type,m_publish_id,m_flag_id,menu_positions,language_id,m_name,m_url,m_title,m_keyword,m_description,content,doc_uplode,linkstatus,	start_date,end_date,approve_status,	admin_id,page_postion,current_version,module_id,media_page,link_category,pdf_body,create_versions_date)
   ...
   FROM project_publish WHERE m_publish_id=$cid";
  mysqli_query($conn,$sql);
	...
	$new =array("$texttype","$projectcategory","$txtpostion","$txtlanguage","$txtename","$url","$page_url","$txtekeyword","$txtmeta_description","$txtcontentdesc","$txtuplode","$link","$startdate","$expairydate","$update_date","$txtstatus","$user_id","$create_version");
$useAVclass->UpdateQuery($tableName_send,$whereclause,$old,$new);
...
$value=$useAVclass->insertQuery($tableName,$tableFieldsName_send,$tableFieldsValues_send);
	...
	$tableFieldsValues_send=array("$texttype","$page_id","$projectcategory","$txtpostion","$txtlanguage","$txtename","$url","$page_url","$txtekeyword","$txtmeta_description","$txtcontentdesc","$txtuplode","$link","$startdate","$expairydate","$update_date","$txtstatus","$user_id","$version");
