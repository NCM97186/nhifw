...
// die();
			...
			// {	 
			if($login_name == $admin_username && $newpwd == trim($password1))
			{
				// echo "hiii";
				// die();
			// if($login_name == $admin_username)
	...
	// exit;
        ...
        else
        {
            ...
            if (value!='')
            {
				...
				// 	   $password1 = hash("sha512", $password,$_SESSION['salt']);
				// 	//    echo $password1;
				// 	//    die();
			...
			// alert(value);
				...
				//  hash = hex_sha512(value + '<?php echo $_SESSION['salt']; ?>');
...
<div class="admin-heading"> <h1><img src="<?php echo $HomeURL;?>/images/nihfw-logo.jpg" class="img-responsive" title="NIHFW" alt="NIHFW" width='350' height='100' > <br /> <br /><i>Administration </i></h1></div>
      ...
      <div class="captcha_row">
	   ...
	   <a tabindex="-1" style="border-style: none" href="index.php" title="Refresh Image" ><img src="../../images/refresh_icon-big.png" alt="Reload Image" border="0"  align="bottom" /></a>
       ...
       <input type="button" name="cmdsubmit" id="cmdsubmit" value="Submit" class="button" onclick ="getPass();" />
