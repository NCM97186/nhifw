...
$sql=mysqli_query($conn,"Select * from schemes_publish $whereclause");
...
<title>Manage schemes add/update: DDA</title>
<!-- admin css  -->
...
<form action="" method="post" name="form1"  autocomplete="off" enctype="multipart/form-data"  onsubmit="return add_cp('form1')">
	...
	if($_GET['editid']!='')
	{
		$rq = mysqli_query($conn,"select * from schemes where 	m_id='".$_GET['editid']."'");
