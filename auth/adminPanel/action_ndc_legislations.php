...
$cat_id='1';
$tableName_send="ndc_legislations";
...
if($txtstatus=='3')
{
$tableName_send="ndc_legislations_publish";
...
header("location:manage_ndc_legislations.php");	
exit;	
}
}
if(isset($_POST['cmdsubmit']) && $_GET['editid']!='')
...
$sql=mysqli_query($conn,"Select * from ndc_legislations_publish $whereclause");
...
if($_GET['editid']!='')
{
        $rq = mysqli_query($conn,"select * from ndc_legislations where id='".$_GET['editid']."'");
