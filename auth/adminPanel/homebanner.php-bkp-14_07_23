...
$tableFieldsName_old=array("b_name","b_title","h_title","	b_language","b_short_desc","b_image_path","approve_status","admin_id");
...
if($txtstatus=='3')
{
	...
	$tableFieldsName_old=array("publish_id","b_name","b_title","h_title","b_language","b_short_desc","b_image_path","approve_status","admin_id");
	...
	$sql="INSERT INTO banner_publish (publish_id,b_name,b_title,h_title,b_language,b_short_desc,b_image_path,approve_status,admin_id)
	 SELECT b_id,b_name,b_title,h_title,b_language,b_short_desc,b_image_path,approve_status,admin_id FROM banner WHERE b_id=$page_id";
