...
<?php 
  ...
  $querywhere .=" and approve_status=$txtstatus"; 
	...
	if($btneng!='')
	  ...
	  if($errmsg=='')	
	  {
 $query ="select * from combine where cat_id=1 $querywhere ORDER BY page_postion ASC "; 
	  }
	 else
	{
...
$wherecluse=" and language_id=$language and approve_status='$txtstatus'";
 ...
 $query ="select * from combine where cat_id=1 $wherecluse ORDER BY page_postion ASC ";
}
?>      
