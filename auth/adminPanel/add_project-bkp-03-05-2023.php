...
if($txtlanguage=='2')
{
	...
	if(trim($txtename)=="")
		...
		// if(trim($texttype)=="")
		// {
		// 	$errmsg .="Please Select project Type."."<br>";
...
else
{
		if(trim($txtename)=="")
		{
		$errmsg .= "project title should be alphanumeric "."<br>";
		}
		if(trim($txtename)!="")
		{			
...
$tableFieldsName_old=array("m_flag_id","m_type","menu_positions","language_id","m_name","m_url","m_title","m_keyword","m_description","content","doc_uplode","linkstatus","start_date","end_date","create_date","update_date","approve_status","admin_id","page_postion","current_version");
$tableFieldsValues_send=array("$projectcategory","$texttype","$txtpostion","$txtlanguage","$txtename","$url","$page_url","$txtekeyword","$txtmeta_description","$txtcontentdesc","$txtuplode","$link","$startdate","$expairydate","$createdate","","$txtstatus","$user_id","","0");
...
$whereclause="where v_type='$texttype' and v_pageid='$page_id' and v_flag_id='$projectcategory' and v_langid='$txtlanguage'";
...
{  $version =1; }
	...
	$tableFieldsName_old=array("m_type","m_publish_id","m_flag_id","menu_positions","language_id","m_name","m_url","m_title","m_keyword","m_description","content","doc_uplode","linkstatus","start_date","end_date","create_date","update_date","approve_status","admin_id","page_postion","current_version");
	$tableFieldsValues_send=array("$texttype","$page_id","$projectcategory","$txtpostion","$txtlanguage","$txtename","$url","$page_url","$txtekeyword","$txtmeta_description","$txtcontentdesc","$txtuplode","$link","$startdate","$expairydate","$createdate","","$txtstatus","$user_id","","$version");
...
$tableFieldsValues_send=array("$texttype","$page_id","$projectcategory","$txtlanguage","$url","$txtepage_title","$txtcontentdesc","$version","$createdate");
$useAVclass->insertQuery($tableName_send,$tableFieldsName_old,$tableFieldsValues_send);
}
if($txtstatus=='4')
{
...
<title>Add project Page :<?php echo $sitename;?></title>
...
<div class="breadcrum">
  <span class="submenuclass"><a href="welcome.php">Dashboard</a></span>
			...
			<span class="submenuclass"><a href="manage_project.php?module_id=1"><?php echo "Manage project";?></a></span>
			 <span class="submenuclass">>> </span> 
			<span class="submenuclass">Add project</span>
...
<p><img alt="error" src="images/error.png"> <span>Attention! <br /></span><?php echo $errmsg; ?></p>
	...
	<div class="internalpage_heading">
 <h3 class="manageuser">Add project</h3>
...
<form action="" method="post" name="form1"  autocomplete="off" enctype="multipart/form-data"  onsubmit="return add_content('form1')">
			...
			<div class="frm_row"> <span class="label1">
				<label for="txtename">Project Title:</label> <span class="star">*</span>
...
<select name="texttype" id="texttype" autocomplete="off"  onChange="addprojecttype(this.value)" >
