...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<title>Manage  Events/Awards/Circular/National Policy: <?php echo $sitename;?></title>
...
<?php 
  ...
  $querywhere .=" and approve_status=$txtstatus"; 
	...
	if($btneng!='')
	  ...
	  if($errmsg=='')	
	  {
 $query ="select * from combine where 1 and(cat_id !=1 and cat_id !=4) $querywhere ORDER BY page_postion ASC "; 
	  }
	 else
	{
...
$query ="select * from combine where 1 and(cat_id !=1 and cat_id !=4) $wherecluse ORDER BY page_postion ASC ";
}
?>      
...
<p><img alt="error" src="images/error.png"> <span>Attention! <br /></span><?php echo $_SESSION['errors']; $_SESSION['errors']="";?></p>
 ...
 <h3 class="manageuser">Manage Events/Awards/Circular/National Policy</h3>
 <div class="right-section">

			 <ul>
			
<?php if($role_map['draft']=='DR' || $user_id=='101'){?><li class="new-icon">
<a href="circular_events.php" title="New"><span class="icon-28-new"></span>New</a></li>
              <?php }?>
