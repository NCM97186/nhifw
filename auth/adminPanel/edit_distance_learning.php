...
$value=$useAVclass->insertQuery($tableName,$tableFieldsName_send,$tableFieldsValues_send);
	...
	$tableFieldsName_send=array("m_type","m_publish_id","m_flag_id","language_id","m_name","m_url","m_title","m_keyword","m_description","content","doc_uplode","linkstatus","update_date","approve_status","admin_id","create_date");
	$tableFieldsValues_send=array("$texttype","$page_id","$distance_learningcategory","$txtlanguage","$txtename","$url","$page_url","$txtekeyword","$txtmeta_description","$txtcontentdesc","$txtuplode","$link","$update_date","$txtstatus","$user_id","$create_date");
