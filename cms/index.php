...
?>
  <?php foreach($leftrows as $key=>$value){
      ...
      $row2 = mysqli_num_rows($sql1);
         if($row2 > 0){ ?>
      <li class="has-sub collapsed expandable"><a href="<?php echo $HomeURL;?>/cms/<?php echo $value['m_url']; ?>" title="<?php echo $value['m_name'];?>"><?php echo $value['m_name'];?></a> 
      ...
      <ul  class="ddsubmenustyle blackwhite">
       ...
       if($row3 > 0){
        ?>
        <li   class="collapsed expandable"><a href="<?php echo $HomeURL;?>/cms/<?php echo $value1['m_url']; ?>" title="<?php echo $value1['m_name'];?>"><?php echo $value1['m_name'];?></a>
      <?php 
      if($num2 >0) { ?>
      <ul   class="ddsubmenustyle blackwhite">
        <?php foreach($leftrows3 as $key=>$value3){
