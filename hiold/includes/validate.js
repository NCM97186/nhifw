...
function add_content(formname)
{
    ...
    if(MM_validateForm(formname,
        'txtename','Please enter menu name','R', 
        'txtepage_title','Please enter page title','R',
        'texttype','Please select Menu Type','R',
        'txtlanguage','Please select language','R',
...
function add_photo(formname)
{

    if(MM_validateForm(formname,
        'galleryid','Please select Category Name','R',
...
{
    if(MM_validateForm(formname,
        'txtename','Please Enter the Name','R',
        'txtemail','Email','RisEmail'
        ))
        {
...
function forgot_password(formname)
{
    ...
    if(MM_validateForm(formname,
		'txtemail','Please enter valid Email Id','R',
        'txtlog','Please enter user name','R',
        'code', 'Image Code','R'))
        {
...
function new_user(formname)
{

    if(MM_validateForm(formname,
		'usertype','Please enter user type','R',
		'txtname','Please enter valid Email Id','R',
		'email','Please enter valid Email Id','R',
		'address','Please enter address','R',
		'state','Please enter state','R',
		'city','Please enter city','R',
		'pincode','Please enter pincode','R'
        ))
        {
...
function reset_password(formname)
{

    if(MM_validateForm(formname,
		'txtnpwd','Please enter new password','R',
        'txtcpwd','Please re-enter password','R',
        'code', 'Image Code','R'))
        {
...
function numbersonly(e){
    ...
    if (unicode!=8){ //if the key isn't the backspace key (which we should allow)
        ...
        {
            alert('Please Enter Number Only ! Numbers Only 10-12 Digits.');
...
function manage_rfd(formname)
	...
	if(MM_validateForm(formname,
			...
			'language_id','Please Select Page Language','R',
			'quarter_doc','Please Select One Option','R',
			'financial_year','Please Select Year','R',
			'txtename','Please Enter Name','R',
			'txtepage_title','Please Enter Page Title','R',
			'user_status','Please Enter Page Title','R',
			'txtuplode','Please Upload  File','R'))
		{
		return true;
		} 
		else{
