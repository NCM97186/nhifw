...
<div id="homeCarousel" class="carousel slide" data-ride="carousel">
    	...
    	<div class="carousel-inner">
						...
						<?php $sqlquery=mysqli_query($conn,"select * from banner_publish where approve_status=3 AND b_language='1' limit 0,1");
							$i=1;
					...
					<?php $sqlquery=mysqli_query($conn,"select * from banner_publish where approve_status=3 AND b_language='1' limit 1,10");
						$i=1;
						while($result=mysqli_fetch_array($sqlquery))
						{
							@extract($result);
    	...
    	<!--Carousel controls -->
    	<a class="carousel-control left" title="Left Button" href="#homeCarousel" data-slide="prev"> <span class="hidethis">Left Button</span> <span class="glyphicon glyphicon-chevron-left"></span> </a> <a class="carousel-control right" title="Right" href="#homeCarousel" data-slide="Right Button"> <span class="hidethis">Right Button</span> <span class="glyphicon glyphicon-chevron-right"></span> </a>
    <!-- Controls -->
