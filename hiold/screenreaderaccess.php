...
<caption> Various Screen Readers :</caption>
		 <tbody><tr>
    <th>Screen Reader</th>
    <th>Website</th>
  ...
  <tr class="odd">
    ...
    <td><a href="http://www.nvda-project.org/" target="_blank" title="External Link thats open in new window" onclick="return confirm('This is external link, Are you sure you want to continue?');">http://www.nvda-project.org&nbsp;</a></td>
    <td>Free</td>
  </tr>
  <tr class="even">
    <td>System Access To Go</td>
    <td><a href="http://www.satogo.com/" target="_blank" title="External Link thats open in new window" onclick="return confirm('This is external link, Are you sure you want to continue?');">http://www.satogo.com&nbsp;</a></td>
    <td>Free</td>
  </tr>
  <tr class="odd">
    <td>Thunder</td>
    <td><a href="http://www.screenreader.net/home.php?pageid=11" target="_blank" title="External Link thats open in new window" onclick="return confirm('This is external link, Are you sure you want to continue?');">http://www.screenreader.net/home.php?pageid=11&nbsp;</a></td>
    <td>Free</td>
  </tr>
</tbody></table>                
 </div> 
