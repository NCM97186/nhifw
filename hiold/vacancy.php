...
<div class="row">
   ...
   <li class = "active"><a href="<?php echo $HomeURL;?>/hi/vacancy.php" title="Vacancy">Vacancy</a></li>
    <?php if($_GET['page']!='') { ?> 
...
<div class="col-md-9 content-area">
  ...
  <table  class="table table-bordered">
			   ...
			   <th>Last Date</th>
				...
				?>
				 ...
				 foreach($newsrows as $key=>$value){ 
					 $docspath = $HomeURL.'/upload/recruitment/'.$value['docs_file'];
			   ...
			   <?php } else { ?>
			   <a href="<?php echo $HomeURL;?>/hi/vacancy.php?page=<?php echo $value['page_url']; ?>" title="<?php echo $value['m_name'];?>"><?php echo $value['m_name'];?></a>
			   <?php } ?>
			   </td>
