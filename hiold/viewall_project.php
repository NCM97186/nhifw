...
<div class="row">
   ...
   <li><a href = "<?php echo $HomeURL;?>" title="Home">मुख्य पृष्ठ</a></li>
   <li class = "active">परियोजनाएं</li>
 ...
 <?php include("completed-project-hi.php");?>

 
          </div>
       <h2 class="heading" style="font-size:30px;">Project</h2></br>
<div style="font-size:20px;" class = "col-md-9 content-area">
<ul>
  <?php
		...
		if($mydb->checkTable_TwoRow("menu_publish","m_flag_id",103,"approve_status",3)>0){
			...
			$whereClause="m_flag_id='103' && approve_status='3' && language_id='2' order by page_postion asc " ;
...
<?php } ?>
  <li class="heading"><a href="http://14.139.63.243/"  title="E-learning">E-learning</a></li>
  <li class="heading"><a href="http://www.nccmis.org/"  title="NCCVMRC">NCCVMRC</a></li>
  <li class="heading"><a href="http://172.16.0.39/"  title="APAR">APAR</a></li>
  <li class="heading"><a href="#"  title="eITEC">eITEC</a></li>
</ul>
</div>
