...
if($mydb->checkTable_threeRow("tender_publish","page_url",$url,"approve_status",3,"language_id",1)>0){
	$date=date('Y-m-d');
			$whereClause="approve_status='3' && language_id='2' && page_url='".$url."'   order by start_date desc" ;
...
<div class="row">
   ...
   <li class = "active"><a href="<?php echo $HomeURL;?>/hi/tender.php" title="Tender">Tender</a></li>
    <?php if($_GET['page']!='') { ?> 
...
<div class="col-md-9 content-area">
  ...
  <table  class="table table-bordered">
			...
			if(is_array($tenderrows)){
			   ...
			   <?php } else { ?>
			   <a href="<?php echo $HomeURL;?>/hi/tender.php?page=<?php echo $value['page_url']; ?>" title="<?php echo $value['m_name'];?>"><?php echo $value['m_name'];?></a>
			   <?php } ?>
			   </td>
