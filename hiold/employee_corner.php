...
<div class="row">
   ...
   <li class = "active"><a href="<?php echo $HomeURL;?>/hi/employee_corner.php" title="Vacancy">Employee Corner</a></li>
    <?php
  ...
  <table  class="table table-bordered">
			   ...
			   <th>Last Date</th>
			    ...
			    <?php if($mydb->checkTableRow("employee_corner_publish")>0){
					$i=1;
					$date=date('Y-m-d');
			$whereClause="approve_status='3' && language_id='2' && category='".$_GET['page']."' && date(end_date ) >= '$date'  order by start_date desc" ;
			   ...
			   <?php } else { ?>
			   <a href="<?php echo $HomeURL;?>/hi/employee_corner.php?page=<?php echo $value['page_url']; ?>" title="<?php echo $value['m_title'];?>"><?php echo $value['m_title'];?></a>
			   <?php } ?>
			   </td>
