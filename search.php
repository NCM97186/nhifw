...
include('../counter.php');
 ...
 $whereClause="approve_status='3' && language_id='1'" ;
...
<input type="hidden" value="009166207481149357514:qxrolw6qhkq" name="cx">
<input type="hidden" value="FORID:10" name="cof">
<input type="hidden" value="UTF-8" name="ie" />
<div class="form-group">
<label for="" class="enterkey">Enter your keywords</label>
<input type="text"  autocomplete="off"  id="q" class="input-bgsearch" name="q" value="<?php echo content_desc(htmlspecialchars($qtext));?>"  />

<input type="image" alt="Search"  class="go_button btn btn-primary" title="Search" /></div>
...
<script>
  (function() {
    var cx = '013280925726808751639:zklt2-4jolq';
