...
<div class="left-menu">
             ...
             <ul class="menu-class treeview">
                  <?php 
                      ...
                      foreach($bottomrows as $key=>$value){  
                        ...
                        if ($value['m_url'] == 'latest-health-news.php') {
                            $url_show = 'ndc-latest-health-news.php';
                            $active1 = 'selected';
                        }
                        ...
                        ?>
                          <li  >
            <a  href="<?php echo $url_show;?>" title="<?php echo $value['m_name'];?>" class="<?php echo $active1; ?>" ><?php echo $value['m_title'];?> </a>
    ...
    <?php
    $date=date('Y-m-d');
    if($mydb->checkTableRow("ndc_latest_health_news_publish")>0){
   ...
   $newsrows=$mydb->gettable_Rows_whereCluse("ndc_latest_health_news_publish",$whereClause); 
...
<div class="col-md-9 content-area">
                <h2 class="heading">Latest Health News </h2>
                
 <table width="100%"  class="table table-bordered">
<caption> Latest Health News </caption>
		<tbody>
			<tr>
				<th>
					Sr.</th>
