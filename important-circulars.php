...
<div class="col-md-9 content-area">
  ...
  <table  class="table table-bordered">
			   ...
			   <a href="<?php echo $docspath; ?>" title="<?php echo $value['m_name'];?>" target="_blank"><?php echo $value['m_name'];?>  &nbsp;&nbsp;<img src="<?php echo $HomeURL; ?>/images/pdf_icon.png" height="16" alt="PDF file" data-name="<?php echo $file; ?>" /> </a><?php echo $size; /*'size:('.formatFilebytes($file,'MB').')';*/ ?>
			   <?php }
