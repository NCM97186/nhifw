...
if($mydb->checkTable_threeRow("project_publish","m_url",$url,"approve_status",3,"language_id",1)>0){
			$contentrows=$mydb->gettable_RowsthreeColumn_where("project_publish","m_url",$url,"approve_status",3,"language_id",1);  
...
<div class="col-md-9 content-area">
			...
			$whereClause="m_flag_id='8' && approve_status='3' && language_id='1' order by page_postion asc" ;
...
?>
			...
			<?php } else { ?>
		<li><a href="<?php echo $HomeURL;?>/project/<?php echo $value1['m_url']; ?>" title="<?php echo $value1['m_name'];?>"><?php echo $value1['m_name'];?></a></li>
