...
<div class="col-md-9 content-area">
                <h2 class="heading"><?php echo $page_name;?></h2>
                	 ...
                	 <a href="http://localhost/nihfw/archive.php?cat=7" style="float: right;"  title="&nbsp;<strong>Archive</strong>">&nbsp;<strong>Archive</strong>&nbsp;<img src="http://localhost/nihfw/images/extlink.png" alt="external link"></a>
                	 <br>
