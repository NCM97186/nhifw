...
if($_SERVER['REQUEST_URI'])
		...
		$open=$val['2'];
		 if($mydb->checkTableRow("emp_category")>0){
					$i=1;
					$date=date('Y-m-d');
			 		$whereClause="status='1' && language_id='1' && page_url='".$url1."'";
...
<div class="col-md-9 content-area">
                <h2 class="heading"><?php echo $page_name;?></h2>
                	 ...
                	 <a href="http://125.20.102.86/nihfw/archive.php?cat=7" style="float: right;"  title="&nbsp;<strong>Archive</strong>">&nbsp;<strong>Archive</strong>&nbsp;<img src="http://125.20.102.86/nihfw/images/extlink.png" alt="external link"></a>
                	 <br>
			   ...
			   <th>Last Date</th>
			    ...
			    <?php if($mydb->checkTableRow("employee_corner_publish")>0){
					$i=1;
					$date=date('Y-m-d');
			$whereClause="approve_status='3' && language_id='1' && category='".$cat."' && end_date >= '$date'  order by start_date desc";
